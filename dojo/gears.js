...
dojo.gears._gearsObject = function(){
	...
	if(typeof GearsFactory != "undefined"){ // Firefox
		...
		// IE
		try{
			factory = new window.ActiveXObject("Gears.Factory");
		}catch(e){
			// squelch
		}
		if(!factory && typeof navigator.mimeTypes != 'undefined' && typeof navigator.mimeTypes["application/x-googlegears"] != 'undefined'){
			factory = document.createElement("object");
			factory.setAttribute("type", "application/x-googlegears");
			factory.setAttribute("width", "0");
			factory.setAttribute("height", "0");
			factory.style.display = "none";
			window.document.documentElement.appendChild(factory);
		}
	}
...
dojo.gears.available = (!!dojo.gears._gearsObject());
