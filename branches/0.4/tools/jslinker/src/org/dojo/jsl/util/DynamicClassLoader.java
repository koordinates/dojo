...
/**
 * ClassLoader for dynamically generated classes.
 * 
 * 
 * @since JDK 1.4
 * @see VisitorFactory
...
public class DynamicClassLoader extends java.lang.ClassLoader {
	...
	public DynamicClassLoader(JavaClass clazz) {
		super();
		this.clazz = clazz;
	}

	public DynamicClassLoader(JavaClass clazz, java.lang.ClassLoader parent) {
		super(parent);
		this.clazz = clazz;
	}
