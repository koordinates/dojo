...
dojo.lang.extend(dojo.widget.TreeNode, {
	...
	templateString: ('<div class="dojoTreeNode"> '
		...
		+ '		<span dojoAttachPoint="titleNode" dojoAttachEvent="onClick: onTitleClick; onMouseOver: onMouseOverTitle" class="dojoTreeNodeLabelTitle">${this.title}</span> '
		+ '</span> '
	...
	*/
	...
	onMouseOverTitle: function(e){
		dojo.event.topic.publish(this.tree.eventNames.titleMouseOver, { source: this, event: e });
	},
