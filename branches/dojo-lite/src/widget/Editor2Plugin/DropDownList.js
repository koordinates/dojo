...
dojo.declare("dojo.widget.Editor2ToolbarFormatBlockSelect", dojo.widget.Editor2ToolbarComboItem, {
	...
	href: dojo.uri.cache.allow(dojo.uri.dojoUri("src/widget/templates/Editor2/EditorToolbar_FormatBlock.html")),
...
dojo.declare("dojo.widget.Editor2ToolbarFontSizeSelect", dojo.widget.Editor2ToolbarComboItem,{
	...
	href: dojo.uri.cache.allow(dojo.uri.dojoUri("src/widget/templates/Editor2/EditorToolbar_FontSize.html")),
...
dojo.declare("dojo.widget.Editor2ToolbarFontNameSelect", dojo.widget.Editor2ToolbarFontSizeSelect, {
	...
	href: dojo.uri.cache.allow(dojo.uri.dojoUri("src/widget/templates/Editor2/EditorToolbar_FontName.html"))
});
