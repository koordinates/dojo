dojo.provide("dojo.data.js.RelationalDataProvider");
...
/*
RelationalDataProvider - Uses multiple "Table" classes associated with the provider itself, having
Attributes based on the column names provided in the data itself.  Does not use refs.
Schema Metadata for Relational schema is registered maintained by the provider.  Either implicitly
in a provider subclass, or by loading the schema definition externally.
*/
dojo.data.js.RelationalDataProvider = function(/* keywords */ keywordParameters) {
	/**
	 * summary:
