...
dojo.required("dijit.form.ValidationTextBox", function() {
	...
	dijit.form.RangeBoundTextBox,
	{
		...
		_mouseWheeled: function(/*Event*/ evt){
			...
			if(scrollAmount !== 0){
				...
				if(!this._wheelTimer){
					dojo._getWin().clearTimeout(this._wheelTimer);
				}
				this._wheelTimer = dojo._getWin().setTimeout(dojo.hitch(this,"_arrowReleased",node), 50);
			}
		...
		postCreate: function(){
			...
			//if(dojo.isIE){
				...
				this.connect(this.domNode, "onresize",
					function(){ dojo._getWin().setTimeout(dojo.hitch(_this,
						function(){
...
dojo.provided("dijit.form._Spinner");
