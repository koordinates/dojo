dojo.provide("dijit.form.ValidationTextBox-face");
...
dojo.declare(
	...
	dijit.form.TextBox,
	{
		...
		_isValidSubset: function(){
			...
			return !this.textbox.value.search(this._partialre);
		},
...
dojo.declare(
	...
	dijit.form.ValidationTextBox,
	{
		...
		toString: function(){
			...
			return (val !== null && val !== undefined) ? (typeof val == "string" ? val : this.serialize(val, this.constraints)) : ""; // String
		},
	...
	dijit.form.MappedTextBox,
	{
		...
		_isDefinitelyOutOfRange: function(){
			...
			if("min" in this.constraints){
				...
				val = this.compare(val, ((typeof min == "number") && min >= 0 && val)? 0 : min);
