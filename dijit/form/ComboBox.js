...
dojo.required(["dojo.i18n", "dijit.form.ValidationTextBox", "dojo.data.util.simpleFetch"], function() {
...
dojo.declare(
	...
	null,
	{
		...
		_onKeyPress: function(/*Event*/ evt){
			...
			switch(key){
				...
				case dk.ENTER:
					...
					evt.preventDefault(); 	// fall through
				case dk.TAB:
			...
			if(this.searchTimer){
				dojo._getWin().clearTimeout(this.searchTimer);
			}
			if(doSearch){
				// need to wait a tad before start search so that the event
				// bubbles through DOM and we have value visible
				dojo._getWin().setTimeout(dojo.hitch(this, "_startSearchFromInput"),1);
			}
		},
		...
		_startSearch: function(/*String*/ key){
			...
			this.searchTimer=dojo._getWin().setTimeout(dojo.hitch(this, function(query, _this){
				var fetch = {
					queryOptions: {
