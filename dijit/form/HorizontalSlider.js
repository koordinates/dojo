...
// Base FX is always included at the moment

dojo.required("dojo._base.fx");
...
dojo.required(["dojo.dnd.move", "dijit.form._FormWidget", "dijit._Container"], function() {
dojo.declare(
	...
	[dijit.form._FormValueWidget, dijit._Container],
{
	...
	_onHandleClick: function(e){
		if(!this.disabled && !this.readOnly){
			console.warn('Executing click/focus workaround (IE)');
	...
	_mouseWheeled: function(/*Event*/ evt){
		...
		if (delta) {
			this[delta < 0 ? "decrement" : "increment"](evt);
		}
	},
