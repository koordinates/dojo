...
dojo.required(["dojo.date.locale", "dojo.date.stamp", "dijit.form.ValidationTextBox"], function() {
			...
			if(!this._picker){
				...
				this._picker = new PopupProto({
					onValueSelected: function(value){
						...
						dojo._getWin().setTimeout(dojo.hitch(textBox, "_close"), 1); // allow focus time to take
...
dojo.provided("dijit.form._DateTimeTextBox");
