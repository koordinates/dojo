...
dojo.required(["dijit._base.focus", "dijit._base.place", "dijit._base.window"], function() {
...
dijit.BackgroundIframe = function(/* DomNode */node){
	...
	// summary:
	//		For IE z-index shenanigans. id attribute is required.
	//
	// description:
	...
	if(dojo.hasClass(dojo.body(), "dijit_a11y")){
		...
		// NOTE: Remove CSS expressions

		if(dojo.isHostMethod(iframe.style, 'setExpression')){
...
dojo.provided("dijit._base.popup");
