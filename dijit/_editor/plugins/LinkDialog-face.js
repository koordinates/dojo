dojo.provide("dijit._editor.plugins.LinkDialog-face");
dojo.required("dijit._editor.plugins.LinkDialog");
	...
	dijit._editor._Plugin,
	{
		...
		_initButton: function(){
			...
			var dropDown = (this.dropDown = new dijit.TooltipDialog({
				...
				onCancel: function(){
					dojo._getWin().setTimeout(dojo.hitch(_this, "_onCloseDialog"),0);
				},
		...
		setValue: function(args){
			...
			// NOTE: Review this (had IE detection)

			if (this.editor.window && dijit._editor.selection) {
