...
(function(){
	...
	var map = {
		html: {
			...
			"spinner": "dojo.widget.Spinner",
			"spinnerintegertextbox": "dojo.widget.Spinner",
			"spinnerrealnumbertextbox": "dojo.widget.Spinner",
			"spinnertimetextbox": "dojo.widget.Spinner",
