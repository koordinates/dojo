...
dojo.docs = new function() {
	// MOW: hacking in the URI here, I really need a tutorial on baseScriptURI
	var inLocalMode = (window.location.href.indexOf("file:") == 0 || window.location.href.indexOf("localhost") > -1);
	this._url = inLocalMode ? dojo.uri.dojoUri("docscripts") : dojo.uri.dojoUri("");
...
// MOW: removing this so it actually works from a web server!
