...
dojo.lang.extend(dojo.widget.TreeSelector, {
	...
	listenTree: function(tree) {
		...
		dojo.event.topic.subscribe(tree.eventNames.titleMouseOver, this, "onMouseOverTitle");		
	...
	unlistenTree: function(tree) {
		...
		dojo.event.topic.unsubscribe(tree.eventNames.titleMouseOver, this, "onMouseOverTitle");
	...
	onMouseOverTitle: function(message){
		//dojo.debugShallow(message.event);
		alert("mouse-over");
	},
