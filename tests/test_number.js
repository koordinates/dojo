...
dojo.requireLocalization("dojo.i18n.calendar","number","en-us");
dojo.requireLocalization("dojo.i18n.calendar","number","en-in");
dojo.requireLocalization("dojo.i18n.calendar","number","fr-fr");
