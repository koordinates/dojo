...
/*dojo.html._boxSizing = (document["compatMode"] &&
	(document["compatMode"] == "BackCompat" ||
	document["compatMode"] == "QuirksMode")) ? true : false;
*/

dojo.html.getInnerWidth = function getInnerWidth (node){
...
dojo.html.getInnerHeight = function getInnerHeight (node){
...
dojo.html.getTotalOffset = function getTotalOffset (node, type){
...
dojo.html.totalOffsetLeft = function totalOffsetLeft (node){
	return dojo.html.getTotalOffset(node, "left");
}

dojo.html.getAbsoluteX = dojo.html.totalOffsetLeft;

dojo.html.totalOffsetTop = function totalOffsetTop (node){
	return dojo.html.getTotalOffset(node, "top");
}

dojo.html.getAbsoluteY = dojo.html.totalOffsetTop;
...
dojo.html.setOpacity = function setOpacity (node, opacity, dontFixOpacity) {
...
dojo.html.insertCssRule = function insertCssRule (selector, declaration, index){
	if(dojo.render.html.ie){
...
dojo.html.removeCssRule = function removeCssRule (index){
	if(!dojo.html.styleSheet){
...
dojo.html.insertCssFile = function insertCssFile (URI, doc, checkDuplicates){
	if(!URI) { return; }
	if(!doc){ doc = document; }
...
dojo.html.getBackgroundColor = function getBackgroundColor (node) {
	var color;
	do{
		color = dojo.dom.getStyle(node, "background-color");
