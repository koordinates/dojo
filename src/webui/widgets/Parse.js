...
dojo.webui.widgets.parse.ParseFragment = function(fragment) {
...
dojo.webui.widgets.parse.ParseFragment.prototype.parsePropertySets = function(fragment) {
	this.propertySets = [];
	for(var item in fragment){
...
dojo.webui.widgets.parse.ParseFragment.prototype.parseProperties = function(fragment) {
	var properties = {};
	for (var item in fragment) {
...
dojo.webui.widgets.parse.ParseFragment.prototype.getPropertySets = function(fragment) {
