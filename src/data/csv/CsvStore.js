...
dojo.declare("dojo.data.csv.CsvStore", dojo.data.Read, {
	...
	initializer: 
		function(/* object */ keywordParameters) {
			var csvFileContents = keywordParameters["string"];
			// dojo.debug("csvFileContents = " + csvFileContents);
			var arrayOfArrays = this._getArrayOfArraysFromCsvFileContents(csvFileContents);
			// dojo.debug("this.arrayOfArrays.length = " + arrayOfArrays.length);
			...
			// dojo.debug("this._arrayOfItems.length = " + this._arrayOfItems.length);
		},
	get:
