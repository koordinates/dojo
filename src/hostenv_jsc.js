...
if (typeof ScriptEngineMajorVersion != 'function' || ScriptEngineMajorVersion() < 7) dj_throw("attempt to use JScript .NET host environment with inappropriate ScriptEngine"); 
...
dojo.hostenv.println = function(s) {print(s);};     // = print
