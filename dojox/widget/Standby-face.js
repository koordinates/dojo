dojo.provide("dojox.widget.Standby-face");
dojo.required("dojox.widget.Standby");
	...
	hide: function(){
		...
		if(this._displayed){
			...
			if (this._resizeCheck !== null) {
				dojo._getWin().clearInterval(this._resizeCheck);
	...
	_size: function(){
		...
		if(this._displayed){
			...
			if(box.h > 0 && box.w > 0){
				...
				//Browser specific styles to try and clone.
			...
			if (this._resizeCheck === null) {
				...
				var self = this;
				this._resizeCheck = dojo._getWin().setInterval(function(){self._size();}, 100);
			}
		}
	},
