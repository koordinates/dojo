...
dojo.required(["dijit._Templated", "dojox.form.manager._FormMixin", "dojox.form.manager._NodeMixin", "dojox.form.manager._ValueMixin", "dojox.form.manager._DisplayMixin", "dojox.form.manager._EnableMixin", "dojox.form.manager._ClassMixin"], function() {
...
dojo.provided("dojox.form.Manager");
