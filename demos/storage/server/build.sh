...
javac -source 1.5 -target jsr14 -cp .:lib/servlet-api.jar:WEB-INF/lib/json-lib-1.0b2-jdk13.jar:WEB-INF/lib/commons-beanutils.jar:WEB-INF/lib/ezmorph-1.0.jar:WEB-INF/lib/commons-lang-2.2.jar org/dojo/moxie/*.java org/dojo/moxie/sync/*.java 
